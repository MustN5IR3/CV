                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-12">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center">
                                        <li class="page-item">
                                            <a class="page-link" href="product-list2.php" tabindex="-1">Previous</a>
                                        </li>
                                        ...
                                        <li class="page-item active"><a class="page-link" href="#">Gloves</a></li>
                                        <li class="page-item"><a class="page-link" href="product-list4.php">Helmets</a></li>
                                        <li class="page-item">
                                            <a class="page-link" href="product-list4.php">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Fireproof gloves</a>
                                    </div>
                                    <div class="product-image">
                                        <img src="img/22.jpg" alt="Product Image">
                                        <div class="product-action2">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">F1 Ferrari gloves</a>
                                    </div>
                                    <div class="product-image">
                                        <img src="img/33.jpg" alt="Product Image">
                                        <div class="product-action2">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">pink gloves</a>
                                    </div>
                                    <div class="product-image">
                                        
                                        <img src="img/44.jpg" alt="Product Image">
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Sparco red gloves</a>
                                    </div>
                                    <div class="product-image">
                                        <img src="img/55.jpg" alt="Product Image">
                                        <div class="product-action2">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Sparco blue gloves</a>
                                    </div>
                                    <div class="product-image">
                                        <img src="img/66.jpg" alt="Product Image">
                                        <div class="product-action2">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        </div>
                                    </div>
