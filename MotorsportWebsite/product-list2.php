                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-12">
                               <nav aria-label="Page navigation example">
                                   <ul class="pagination justify-content-center">
                                       <li class="page-item">
                                           <a class="page-link" href="product-list.php" tabindex="-1">Previous</a>
                                       </li>
                                       <li class="page-item"><a class="page-link" href="product-list.php">Suits</a></li>
                                       <li class="page-item active"><a class="page-link" href="#">Shoes</a></li>
                                       ...
                                       <li class="page-item">
                                           <a class="page-link" href="product-list3.php">Next</a>
                                       </li>
                                   </ul>
                               </nav>
                            </div>                           
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Light Ferrari shoes</a>
                                    </div>
                                    <div class="product-image">
                                        <img src="img/1.webp" alt="Product Image">
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Basic Puma motorsports shoes</a>
                                    </div>
                                    <div class="product-image">
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Heavy Puma Ferrari shoes</a>
                                    </div>
                                    <div class="product-image">
                                        <img src="img/3.webp" alt="Product Image">
                                        <div class="product-action1">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Red Ferrari motorsport shoes</a>
                                    </div>
                                    <div class="product-image">
                                        
                                        <img src="img/4.webp" alt="Product Image">
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Black Ferrari motorsport shoes</a>
                                    </div>
                                    <div class="product-image">
                            ...
                            <div class="col-md-4">
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="#">Ultra lightweight Ferrari shoes</a>
                                    </div>
                                    <div class="product-image">
                                        <img src="img/6.webp" alt="Product Image">
                                        <div class="product-action1">
                                            <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        </div>
                                    </div>
